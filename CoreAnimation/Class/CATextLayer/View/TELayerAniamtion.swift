...
class TELayerAniamtion: NSObject {
    ...
    class func textLayerAnimation(layer:CALayer, durationTime duration:NSTimeInterval, delayTime delay:NSTimeInterval,animationClosure effectAnimation:effectAnimatableLayerClosure?, completion finishedClosure:completionClosure?) -> Void
    {
